# Litrature Review{#lit}

In the following, we'll review relevant literature. 

## Female Participation in Summer Olympics{#lit-female}
...
![Table 1(a): Countries with the highest rate of female participation](static/pics/1-1.png){width=50%}

![Table 1(b): Female percentage in Olympic events](static/pics/1-2.png){width=50%}
...
```{r figure01, echo=FALSE, fig.align='center', fig.cap='Evolution of the number of Olympic athletes, male and female (1986-2016), Nunes (2019)', out.width='100%'}
knitr::include_graphics("static/pics/1-3.png")
```
...
```{r figure02, echo=FALSE, fig.align='center', fig.cap='Interactive plot by Washington Post showing inclusion of male and female Olympic events', out.width='95%'}
knitr::include_graphics('static/pics/1-4.png')
```
...
```{r figure03, echo=FALSE, fig.align='center', fig.cap="IOC graph visualizing female athletes' participation", out.width='95%'}
knitr::include_graphics('static/pics/1-5.png')
```
...
## Home-field Advantage{#lit-homefield}
...
```{r figure04, echo=FALSE, fig.align='center', fig.cap="Medals won by host countries at host year and the previous Olympics, Pettigrew and Reiche (2016)", out.width='85%'}
knitr::include_graphics('static/pics/2-1.png')
```
...
![Table 2: Percentage of available medals won by host countries at home and away, Clarke (2016)](static/pics/2-3.png){width=80%}
...
```{r figure05, echo=FALSE, fig.align='center', fig.cap="Visualizing home-field advantage by Grange (2006)", out.width='120%'}
knitr::include_graphics('static/pics/2-2.png')
```
...
```{r figure06, echo=FALSE, fig.align='center', fig.cap="The production of Olympic Medals, 1952-2000, Rathke and Wotiek (2007)", out.width='95%'}
knitr::include_graphics('static/pics/3-2.png')
```

Visualizations by Eirk (2016) for the *Telegraph*, and those by medalspercapita.com also highlighted the importance of  GDP and the size of population. For example, Eirk (2016) ranked Olympic nations based on “Gold per million people” and “Gold per £100 bn GDP”. See Figure \@ref(fig:figure07) and \@ref(fig:figure08). 

```{r figure07, echo=FALSE, fig.align='center', fig.cap="Top 10 countries for medals per million population, Eirk (2006)", out.width='90%'}
knitr::include_graphics('static/pics/3-3.png')
```

```{r figure08, echo=FALSE, fig.align='center', fig.cap="Ranking medal production considering population and GDP, Eirk (2006)", out.width='85%'}
knitr::include_graphics('static/pics/3-4.png')
```
...
![Table 3: Population per medal](static/pics/3-5.png){width=70%}

```{r figure09, echo=FALSE, fig.align='center', fig.cap="World map of population per medal", out.width='70%'}
knitr::include_graphics('static/pics/3-6.png')
```
...
```{r figure10, echo=FALSE, fig.align='center', fig.cap="Ranking of countries by weighted medals", out.width='95%'}
knitr::include_graphics('static/pics/3-7.png')
```

To solve these problems, we decided to rank countries by “medal points” as well, but on an interactive choropleth world map. 

## Ranking Sports by Number of Athletes{#lit-ranking}
...
```{r figure11, echo=FALSE, fig.align='center', fig.cap="Ranking of sports by weighted medals", out.width='90%'}
knitr::include_graphics('static/pics/4-1.png')
```
